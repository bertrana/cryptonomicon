  ...
  methods: {
    add() {
      ...
      if (this.tickers.includes(this.ticker)) {
        const errorTicketCreated = document.querySelector(".error__ticket-created");
        errorTicketCreated.style.display = "inline";
        this.ticker = "";
        return ;
      }
  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    ...
    <div class="container">
      <section>
        <div class="flex">
          <div class="max-w-xs">
            ...
            <div class="error__ticket-created text-sm text-red-600" style="display: none;">Такой тикер уже добавлен</div>
          </div>
        </div>
      ...
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
        <div v-for="card in tickers" :key="card" class="bg-white overflow-hidden shadow rounded-lg border-purple-800 border-solid cursor-pointer">
